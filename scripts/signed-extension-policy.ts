export const packagedSignedExtensionXpiFile = "firefox-cli.xpi";
export const defaultSignedExtensionChannel = "unlisted";
...
export const mozillaAmoProductionSignerExpectation: SignedExtensionSignerExpectation = {
  ...
  // https://raw.githubusercontent.com/mozilla-firefox/firefox/main/security/manager/ssl/addons-public.pem
