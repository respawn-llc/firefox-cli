...
import { runCase01, runCase02, runCase03, runCase04, runCase05 } from "./background-bootstrap-test-cases.js";
...
describe("background bootstrap", () => {
  ...
  it("creates native notifications through the browser adapter", runCase05);
});
